...
var syncFallback, useInsertionEffect2, useInsertionEffectAlwaysWithSyncFallback, useInsertionEffectWithLayoutFallback;
...
var isDevelopment3, EmotionCacheContext, CacheProvider, withEmotionCache, ThemeContext, hasOwn, typePropName, createEmotionProps, Insertion, Emotion, Emotion$1;
...
var import_hoist_non_react_statics, jsx, Global;
...
var isDevelopment4, testOmitPropsOnStringTag, testOmitPropsOnComponent, getDefaultShouldForwardProp, composeShouldForwardProps, Insertion3, createStyled;
...
function GlobalStyles(props) {
  ...
  const globalStyles = typeof styles3 === "function" ? (themeInput) => styles3(isEmpty(themeInput) ? defaultTheme4 : themeInput) : styles3;
  return /* @__PURE__ */ _jsx2(Global, {
    styles: globalStyles
  });
}
...
var require_createStyled = __commonJS({
  "node_modules/@mui/system/createStyled.js"(exports) {
    ...
    function processStyleArg2(callableStyle, _ref, layerName) {
      let {
        ownerState
      } = _ref, props = (0, _objectWithoutPropertiesLoose2.default)(_ref, _excluded27);
      ...
      if (!!resolvedStylesArg && typeof resolvedStylesArg === "object" && Array.isArray(resolvedStylesArg.variants)) {
        const {
          variants = []
        } = resolvedStylesArg, otherStyles = (0, _objectWithoutPropertiesLoose2.default)(resolvedStylesArg, _excluded28);
    ...
    function createStyled5(input = {}) {
      ...
      return (tag, inputOptions = {}) => {
        (0, _styledEngine.internal_processStyles)(tag, (styles3) => styles3.filter((style3) => !(style3 != null && style3.__mui_systemSx)));
        const {
          name: componentName,
          slot: componentSlot,
...
var require_useThemeWithoutDefault = __commonJS({
  "node_modules/@mui/system/useThemeWithoutDefault.js"(exports) {
    ...
    var React46 = _interopRequireWildcard(__require("react"));
...
function createBox(options = {}) {
  ...
  const Box2 = /* @__PURE__ */ React9.forwardRef(function Box3(inProps, ref) {
    ...
    return /* @__PURE__ */ _jsx3(BoxRoot, _extends({
      as: component,
      ref,
...
var RtlContext = /* @__PURE__ */ React19.createContext();
...
var PropsContext = /* @__PURE__ */ React20.createContext(void 0);
...
function createContainer(options = {}) {
  ...
  const Container2 = /* @__PURE__ */ React21.forwardRef(function Container3(inProps, ref) {
    ...
    return (
      ...
      /* @__PURE__ */ _jsx6(ContainerRoot, _extends({
        as: component,
        ownerState,
...
function FocusTrap(props) {
  ...
  return /* @__PURE__ */ _jsxs(React23.Fragment, {
    children: [/* @__PURE__ */ _jsx7("div", {
      tabIndex: open ? 0 : -1,
      onFocus: handleFocusSentinel,
      ref: sentinelStart,
      "data-testid": "sentinelStart"
    }), /* @__PURE__ */ React23.cloneElement(children, {
      ref: handleRef,
      onFocus
    }), /* @__PURE__ */ _jsx7("div", {
      tabIndex: open ? 0 : -1,
...
var Portal = /* @__PURE__ */ React24.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  ...
  const handleRef = useForkRef(/* @__PURE__ */ React24.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (/* @__PURE__ */ React24.isValidElement(children)) {
      ...
      return /* @__PURE__ */ React24.cloneElement(children, newProps);
    }
    return /* @__PURE__ */ _jsx8(React24.Fragment, {
      children
    });
  }
  return /* @__PURE__ */ _jsx8(React24.Fragment, {
...
var TransitionGroupContext_default = React26.createContext(null);
...
var Transition = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return (
      ...
      /* @__PURE__ */ React27.createElement(TransitionGroupContext_default.Provider, {
        value: null
      }, typeof children === "function" ? children(status, childProps) : React27.cloneElement(React27.Children.only(children), childProps))
    );
  };
  return Transition2;
}(React27.Component);
...
var TransitionGroup = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    delete props.exit;
    if (Component === null) {
      return /* @__PURE__ */ React28.createElement(TransitionGroupContext_default.Provider, {
        value: contextValue
      }, children);
    }
    return /* @__PURE__ */ React28.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, /* @__PURE__ */ React28.createElement(Component, props, children));
  };
...
var Fade = /* @__PURE__ */ React29.forwardRef(function Fade2(props, ref) {
  ...
  return /* @__PURE__ */ _jsx10(TransitionComponent, _extends({
    appear,
    in: inProp,
...
var Backdrop = /* @__PURE__ */ React30.forwardRef(function Backdrop2(inProps, ref) {
  ...
  return /* @__PURE__ */ _jsx11(TransitionComponent, _extends({
    in: open,
    timeout: transitionDuration
  }, other, {
    children: /* @__PURE__ */ _jsx11(BackdropRoot, _extends({
      "aria-hidden": true
    }, rootSlotProps, {
...
var Modal = /* @__PURE__ */ React32.forwardRef(function Modal2(inProps, ref) {
  ...
  return /* @__PURE__ */ _jsx12(Portal_default, {
    ref: portalRef,
    container,
    disablePortal,
    children: /* @__PURE__ */ _jsxs2(RootSlot, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? /* @__PURE__ */ _jsx12(BackdropSlot, _extends({}, backdropProps)) : null, /* @__PURE__ */ _jsx12(FocusTrap_default, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
        isEnabled: isTopModal,
        open,
        children: /* @__PURE__ */ React32.cloneElement(children, childProps)
      })]
    }))
  });
});
...
var TouchRipple = /* @__PURE__ */ React34.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  return /* @__PURE__ */ _jsx14(TouchRippleRoot, _extends({
...
var ButtonBase = /* @__PURE__ */ React35.forwardRef(function ButtonBase2(inProps, ref) {
  ...
  return /* @__PURE__ */ _jsxs3(ButtonBaseRoot, _extends({
    as: ComponentProp,
    className: clsx_default(classes.root, className),
    ownerState,
    onBlur: handleBlur,
    ...
    children: [children, enableTouchRipple ? (
      ...
      /* @__PURE__ */ _jsx15(TouchRipple_default, _extends({
        ref: handleRippleRef,
        center: centerRipple
      }, TouchRippleProps))
    ) : null]
...
var Fab = /* @__PURE__ */ React36.forwardRef(function Fab2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiFab"
  });
  ...
  return /* @__PURE__ */ _jsx16(FabRoot, _extends({
    className: clsx_default(classes.root, className),
    component,
    disabled,
...
var Typography = /* @__PURE__ */ React37.forwardRef(function Typography2(inProps, ref) {
  ...
  return /* @__PURE__ */ _jsx17(TypographyRoot, _extends({
    as: Component,
    ref,
    ownerState,
    className: clsx_default(classes.root, className)
...
var PopperTooltip = /* @__PURE__ */ React38.forwardRef(function PopperTooltip2(props, forwardedRef) {
  ...
  return /* @__PURE__ */ _jsx18(Root, _extends({}, rootProps, {
...
var Popper = /* @__PURE__ */ React38.forwardRef(function Popper2(props, forwardedRef) {
  ...
  return /* @__PURE__ */ _jsx18(Portal_default, {
    disablePortal,
    container,
    children: /* @__PURE__ */ _jsx18(PopperTooltip, _extends({
      anchorEl,
      direction,
      disablePortal,
      modifiers,
...
var Popper3 = /* @__PURE__ */ React39.forwardRef(function Popper4(inProps, ref) {
  ...
  return /* @__PURE__ */ _jsx19(PopperRoot, _extends({
    as: component,
...
var Button = /* @__PURE__ */ React42.forwardRef(function Button2(inProps, ref) {
  ...
  return /* @__PURE__ */ _jsxs4(ButtonRoot, _extends({
    ownerState,
...
var Grow = /* @__PURE__ */ React43.forwardRef(function Grow2(props, ref) {
  ...
  return /* @__PURE__ */ _jsx21(TransitionComponent, _extends({
    appear,
    in: inProp,
    nodeRef,
    onEnter: handleEnter,
...
var getTextDecoration = ({
  ...
  return (0, import_colorManipulator3.alpha)(color2, 0.4);
};
...
var Link = /* @__PURE__ */ React44.forwardRef(function Link2(inProps, ref) {
  ...
  return /* @__PURE__ */ _jsx22(LinkRoot, _extends({
    color: color2,
    className: clsx_default(classes.root, className),
...
var Tooltip = /* @__PURE__ */ React45.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = /* @__PURE__ */ React45.isValidElement(childrenProp) ? childrenProp : /* @__PURE__ */ _jsx23("span", {
    children: childrenProp
  });
  const theme = useTheme4();
  const isRtl = useRtl();
  ...
  return /* @__PURE__ */ _jsxs5(React45.Fragment, {
    children: [/* @__PURE__ */ React45.cloneElement(children, childrenProps), /* @__PURE__ */ _jsx23(PopperComponent, _extends({
      ...
      }) => /* @__PURE__ */ _jsx23(TransitionComponent, _extends({
        timeout: theme.transitions.duration.shorter
      }, TransitionPropsInner, transitionProps, {
        children: /* @__PURE__ */ _jsxs5(TooltipComponent, _extends({}, tooltipProps, {
          children: [title, arrow2 ? /* @__PURE__ */ _jsx23(ArrowComponent, _extends({}, tooltipArrowProps, {
            ref: setArrowRef
          })) : null]
        }))
      }))
